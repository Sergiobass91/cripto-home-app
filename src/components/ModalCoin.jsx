  ...
  return (
    <ReactModal isOpen={onOpen} style={styleForModal}>
      <button
        ...
        className="text-white text-2xl absolute top-4"
      >
        X
      </button>
      ...
      <div className="grid grid-cols-8 h-full">
        ...
        <div className="flex flex-col col-span-2 justify-center items-center">
          <img className="w-20 h-20" src={coin?.webp64} alt={coin.name}></img>
        ...
        <div className="col-span-6 my-auto">
          <div className="grid grid-cols-6 gap-1 sm:gap-8 justify-items-center">
            ...
            <div>
              <h5>$ Max.</h5>
              <p className="text-white font-semibold">
                {addLocalCurrency(coin.allTimeHighUSD, fiat)}
              </p>
            </div>
            <div>
              <h5>Capital</h5>
            ...
            <div>
              <h5>Hora</h5>
              <p className={customStyleRate(coin.delta.hour)}>
                {deltaPercentage(coin.delta.hour)}
              </p>
              {customResourceRate(coin.delta.hour)}
            </div>
            <div>
              <h5>Día</h5>
              <p className={customStyleRate(coin.delta.day)}>
                {deltaPercentage(coin.delta.day)}
              </p>
              {customResourceRate(coin.delta.day)}
            </div>
            <div>
              <h5>Mes</h5>
              <p className={customStyleRate(coin.delta.month)}>
                {deltaPercentage(coin.delta.month)}
              </p>
